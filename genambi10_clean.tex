...
the \emph{Culex naranvirus 1} and \emph{Zhejiang mosquito virus 3} ambigrammatic viruses 
indicates that the open reading frame on the complementary strand does \emph{not} code for a 
functional protein. This ambigrammatic \emph{Culex naranvirus 1} gene has been shown to be 
associated with an apparently symbiotic companion RNA molecule, also ambigrammatic, termed \lq Robin'. 
We find a comparable companion gene for \emph{Zhejiang mosquito virus 3}. Our analysis of 
the polymorphism of the Robin genes suggests that their reverse open reading frame also does not 
code for a protein. We make a hypothesis about their role.} 
...
containing the ZMV virus \MW{********(Gytis could add description here?)********}
