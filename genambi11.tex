...
We can look for evidence that the doubly-synonymous loci are experience more substitutions than other loci.
...
segments are comparable in their pairwise nucleotide diversity, for both CNV and ZMV.
...
for the third nucleotide in each codon, as expected for a sequence that preserves the amino acid sequence
...
higher for the Robin sequences than it is for the RdRp sequences.
...
of all four ORFs. As expected, there is evidence that some regions accumulate mutations more readily than others.
...
We determined the set of $N_{\rm d}$ doublu-synonymous codons in the consensus sequence, and
...
observations of polymorphisms in two ambigrammatic narnaviruses: Culex 1
and Zheijiang mosquito 3. There was no evidence that doubly synonymous
...
If the rORF (reverse open reading frame) of both the RdRp and the Robin segment
...
an alternative function of the Robin segment may be just about anything, like viral suppression of RNAi\cite{mie_14} or formation of syncytia or viral particles.
